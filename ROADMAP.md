...
**Son biten:** M2.2 **tested** (2026-08-19) — paylaşılabilir aylık özet kartı `/card.svg` (800x418, koyu tema, sıfır ek bağımlılık). PR #11 merge `ff6308f`, CI 3/3 yeşil, 8 yeni test (toplam 58). `verified` için Umut'un canlı ekran görüntüsü bekleniyor: https://enflasyonum-7gcn.onrender.com/card.svg (Render auto-deploy ~5 dk).
**Sıradaki iş:** 14 gün harcama girişi (M1 Done kapanışı, ~2026-09-01); kod tarafında M2.3 (harcama geçmişi grafiği).
...
| M2.2 | Aylık özet kartı (paylaşılabilir görsel) | `/card.svg` 800x418 sosyal medya kartı döner (kişisel vs resmi + fark + top-3 kategori); veri yoksa ipucu kartı, asla 500 | **tested** (PR #11 `ff6308f`, CI 3/3, 2026-08-19) |
