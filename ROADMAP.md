...
**Son biten:** M1.2 — PG şeması + Alembic migration + testli CRUD (PR #2, merge `971b6dc`, CI 3/3 yeşil, gerçek PostgreSQL 16'ya karşı).
**Sıradaki tek iş:** M1.3 — harcama giriş formu (tek sayfa web UI).
